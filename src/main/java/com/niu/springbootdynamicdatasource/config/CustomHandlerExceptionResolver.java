...
import com.niu.springbootdynamicdatasource.common.CommonConstant;
import com.niu.springbootdynamicdatasource.common.CommonResponse;
import com.niu.springbootdynamicdatasource.common.ResponseCode;
		...
		if (handler instanceof HandlerMethod) {
			...
			if (ex instanceof ServiceException) {
				...
				String message = String
					.format("interface [%s] has exception,method is %s.%s, exception message is %s",
			...
			if (ex instanceof NoHandlerFoundException) {
				commonResponse.setCode(ResponseCode.NOT_FOUND)
